...
El perfecto rompehielos para las contribuciones de código abierto; arreglar un error ortográfico es fácil y no requiere casi ninguna experiencia en gitubes o gitanos.
...
1.4. Haga clic en el botón "Proponer cambio de archivo" (Propose changes) que está debajo del todo.  
...
2.4. Haga clic en el botón "Proponer cambio de archivo" (Propose changes) que está debajo del todo. 
